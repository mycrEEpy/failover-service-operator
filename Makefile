...
# mycreepy.github.io/failover-service-operator-bundle:$VERSION and mycreepy.github.io/failover-service-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= mycreepy.github.io/failover-service-operator
...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	$(CONTROLLER_GEN) rbac:roleName=fos-manager crd webhook paths="./..." output:crd:artifacts:config=config/crd/bases
...
run: manifests generate fmt vet ## Run a controller from your host.
	go run ./cmd/fos-manager/main.go

.PHONY: release
release: generate fmt vet ## Release manager binary.
	goreleaser build
